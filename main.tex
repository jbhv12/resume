...
\small{\item{
              ...
              \textbf{Frameworks \& APIs:}{ Spring Boot, Maven, Laravel, .NET, FastAPI, Flask, Django, VueJS, LangChain, Postman, Swagger} \\ \vspace{3pt}
...
\small{\item{
              \resumeItemListStart
              \resumeItem{AWS Certified Professional Solutions Architect}
