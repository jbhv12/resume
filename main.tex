...
\small{\item{
              ...
              \textbf{Frameworks \& APIs:}{ Spring Boot, Maven, Laravel, .NET, FastAPI, Flask, Django, LangChain, Postman, Swagger} \\ \vspace{3pt}
...
\resumeItem{Collaborate closely with Sales and Product Managers to align product direction with and market demands}
...
\resumeItem{Refactored critical components of a monolithic, resulting in improved maintainability and deployment flexibility}
\resumeItem{Improved test coverage from 10\% to 60\% by implementing automated testing pipelines and enforcing quality gates}
\resumeItem{Coordinated with cross-functional teams, including product management, quality assurance, and customer support, to gather requirements, define project scope, and ensure the timely delivery of high-quality solutions}
\resumeItemListEnd
